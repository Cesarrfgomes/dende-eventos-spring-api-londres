...
Este projeto depende do framework:

- **springframework** – Framework web Java amplamente utilizado no mercado para o desenvolvimento de APIs REST.

### Dependências utilizadas neste projeto

- **org.springframework.boot:spring-boot-starter-webmvc** – Starter do Spring Boot para construção de aplicações web/REST com Spring MVC.
- **org.springdoc:springdoc-openapi-starter-webmvc-ui:3.0.2** – Geração automática de documentação OpenAPI/Swagger UI.
- **org.projectlombok:lombok** – Redução de código boilerplate (getters, setters, construtores, etc.) via anotações.
- **org.springframework.boot:spring-boot-starter-webmvc-test** – Suporte a testes para aplicações Spring MVC.
- **org.junit.platform:junit-platform-launcher** – Launcher do JUnit Platform para execução de testes.
